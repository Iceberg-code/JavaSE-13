...
*           throw关键字后面创建的是RuntimeException或者是RuntimeException的子类对象，可以不做处理，默认交给JVM处理（打印异常对象，中断程序）
...
//        int e = getElement(arr, 3);
    ...
    *
    * 注意：
    *       NullPointerException：是一个运行期异常，默认交给JVM处理
    *       ArrayIndexOutOfBoundsException：是一个运行期异常，默认交给JVM处理
    * */
